  ...
  function SelectRoot(
    ...
    return (
      ...
      >
        <div
          className={SubframeUtils.twClassNames(
            "group/bb88f90b flex cursor-pointer flex-col items-start gap-1 rounded-md border border-solid border-neutral-border bg-default-background",
            className
          )}
          ref={ref}
          {...otherProps}
        >
          ...
          <div
            className={SubframeUtils.twClassNames(
              "flex h-8 w-full flex-none flex-col items-start rounded-md group-focus-within/bb88f90b:border group-focus-within/bb88f90b:border-solid group-focus-within/bb88f90b:border-brand-primary",
              {
